...
export const metadata = { title: 'New loan · Lending App' }
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-2 text-2xl font-semibold tracking-tight">New loan</h1>
        <p className="text-muted-foreground text-sm">
          The interest and everyone&rsquo;s share are worked out once, when you save.
        </p>
      </div>
